...
<div id="mbinsmenu0ebul_wrapper" style="max-width: 434px;">
  ...
  <li><div class="buttonbg gradient_button gradient42"><div class="arrow"><a class="button_3">Dosen</a></div></div>
    ...
    <li class="gradient_menuitem gradient33"><a title=""><a href="tambahdosen.php">Tambah</a></li>
    <li class="gradient_menuitem gradient33 last_item"><a title=""><a href="editdosen.php">Edit</a></li>
    </ul></li>
                 ...
                 <th>NO.HP</th>
                   ...
                   <tbody>
                        <?php     //query ke database SELECT tabel mahasiswa urut berdasarkan id yang paling besar
                          $sql = mysqli_query($koneksi, "SELECT a.kd_dosen,a.nama_dosen,a.alamat,a.email,a.hp FROM dosen as a")
                                         ...
                                         <td>'.$data['kd_dosen'].'</td>
                                           <td>'.$data['nama_dosen'].'</td>
                                               <td>'.$data['alamat'].'</td>
                                                 ...
                                                 <td>'.$data['hp'].'</td>
                                                      <td>        
                                                           <a href="delete.php?id='.$data['kd_dosen'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>        </td>
                                                          </tr>
                                                             ';
