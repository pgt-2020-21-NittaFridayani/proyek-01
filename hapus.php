                         ...
                         <li class="nav-item">    
                                <a class="nav-link" href="tambah.php">Tambah</a>     
                                     ...
                                     if(isset($_GET['id'])){    //membuat variabel $id untuk menyimpan id dari GET id di URL   
                                         ...
                                         $select = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE id='$id'") or die(mysqli_error($koneksi));        //jika hasil query = 0 maka muncul pesan error    
                                         if(mysqli_num_rows($select) == 0)
                                         {     
                                             echo '<div class="alert alert-warning">ID tidak ada dalam database.</div>';     exit();    //jika hasil query > 0    
