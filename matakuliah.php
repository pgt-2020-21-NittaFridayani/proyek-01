              ...
              <th>SKS</th>
                   ...
                   <tbody>
                        <?php     //query ke database SELECT tabel mahasiswa urut berdasarkan id yang paling besar
                          $sql = mysqli_query($koneksi, "SELECT a.kd_mk,a.nama_mk,a.sks FROM matakuliah as a")
                                    ...
                                    <td>'.$no.'</td>
                                         <td>'.$data['kd_mk'].'</td>
                                           <td>'.$data['nama_mk'].'</td>
                                               <td>'.$data['sks'].'</td>
                                                      <td>         
                                                      <a href="edit.php?id='.$data['kd_mk'].'" class="badge badge-warning">Edit</a>
                                                           <a href="delete.php?id='.$data['kd_mk'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>        
                                                           </td>
                                                          </tr>
                                                             ';
