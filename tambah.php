     ...
     <head> 
          ...
          <body> 
               <nav class="navbar navbar-expand-lg navbar-light bg-light">  
                    <div class="container"> 
                           <marquee><a class="navbar-brand" href="#" align="center">Harap Jangan Asal</a></marquee>  
                                                     ...
                                                     {   
                                                       $id   = $_POST['id'];
                                                          ...
                                                          $jenis_kelamin = $_POST['jenis_kelamin']; 
                                                           ...
                                                           $cek = mysqli_query($koneksi, "INSERT INTO mahasiswa (id, nim, nama, jenis_kelamin, jurusan) 
                                                           VALUES ();") or die(mysqli_error($koneksi));        
                                                           if(mysqli_num_rows($cek) == 0){   
                                                                  $sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(id, nim, nama, jenis_kelamin, jurusan) 
                                                                  VALUES('$id', '$nim', '$nama', '$jenis_kelamin', '$jurusan')") or die(mysqli_error($koneksi));          
                                                           if($sql){      echo '<script>alert("Berhasil menambahkan data."); document.location="tambah.php";</script>';    
                                                            }else{      echo '<div class="alert alert-warning">Gagal melakukan proses tambah data.</div>';     }    
                                                            }else{     echo '<div class="alert alert-warning">Gagal, NIM sudah terdaftar.</div>';    }   }   ?>     
                                                             ...
                                                             <div class="col-sm-10">     
                                                              ...
                                                              <div class="form-group row">     <label class="col-sm-2 col-form-label">NAMA MAHASISWA</label>     
                                                              <div class="col-sm-10">      <input type="text" name="nama" class="form-control" required>     
                                                              </div>    </div>    
                                                              <div class="form-group row">    
                                                               ...
                                                               <div class="form-check">       <input type="radio" class="form-check-input" name="jenis_kelamin" value="PEREMPUAN" required> 
      <label class="form-checklabel">PEREMPUAN</label>      
      </div>     </div>    </div>   
       <div class="form-group row">     
       ...
       <option value="TEKNIK INFORMATIKA">TEKNIK ELEKTRONIKA</option>      
        ...
        <option value="PERTANIAN">TEKNIK INDUSTRI</option>      </select>     
